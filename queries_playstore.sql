...
SELECT app_name, reviews, min_installs, CONCAT(reviews/(min_installs/100), '%') AS proportion FROM analytics
WHERE min_installs >= 100000
ORDER BY (reviews/(min_installs/100)) DESC
LIMIT 1;

-- 16. FS1. Find the name and rating of the top rated apps in each category, among apps that have been installed at least 50,000 times. --
...
-- 17. FS2. Find all the apps that have a name similar to “facebook”. --
SELECT app_name FROM analytics
WHERE app_name ILIKE '%facebook%';

-- 18. FS3. Find all the apps that have more than 1 genre. --
...
-- 19. FS4. Find all the apps that have education as one of their genres. --
-- https://www.postgresql.org/docs/current/functions-array.html#ARRAY-FUNCTIONS-TABLE --
SELECT app_name, genres FROM analytics
